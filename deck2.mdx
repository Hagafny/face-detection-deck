...
import { AnimatedIconsSlide } from './slides/AnimatedIconsSlide.js'
...
<SlideLayout title='Agenda' direction='column'>
  <AnimatedIconsSlide icons={[rocket,seo]} />
...
<SlideLayout title='The Crop Problem'>
...
<SlideLayout title='Good Crop /  Bad Crop'>
 Images of before and after the crop
</SlideLayout>
