...
<CropSimulatorPhase phase={0} src={smartCropExample} style={{width:'400px', height: '600px'}} />
...
<CropSimulatorPhase phase={1} src={smartCropExample} style={{width:'400px', height: '600px'}} />
...
<CropSimulatorPhase phase={2} src={smartCropExample} style={{width:'400px', height: '600px'}} />
...
<CropSimulatorPhase phase={3}  src={smartCropExample} style={{width:'400px', height: '600px'}} />
